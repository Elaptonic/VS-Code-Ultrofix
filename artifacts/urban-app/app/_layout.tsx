...
function AuthGate() {
  ...
  // Cast to string[]: the typed-route segment tuple (generated by `expo start`)
  // isn't present in this checkout, so `useSegments()` falls back to a 1-tuple
  // type that doesn't cover the deeper routes (e.g. vendor/onboarding) checked below.
